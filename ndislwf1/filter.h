...
#define FILTER_FRIENDLY_NAME        L"ndislwf1 NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{ac184482-d51f-4adf-aba2-80552eac5656}" //unique name, quid name
...
DRIVER_DISPATCH ndislwf1Dispatch;

DRIVER_DISPATCH ndislwf1DeviceIoControl;
